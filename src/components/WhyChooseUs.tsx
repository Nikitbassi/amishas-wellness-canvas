        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 md:p-12">
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="relative">
              <img alt="Dietitian Amisha with clients" src="/lovable-uploads/7b498802-160c-40f9-aad9-2a7a4db73d13.png" className="w-full h-96 rounded-2xl shadow-lg object-cover" />
